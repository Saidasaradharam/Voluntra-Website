  ...
  <div className="bg-white rounded-lg shadow p-8">
    ...
    <div className="space-y-4">
      <div className="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg">
        ...
        <p className="text-[#0D1B2A] font-semibold">View Scheduled Events</p>
      </div>
      <div className="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg">
        <DollarSign size={24} className="text-[#0D1B2A]" />
        <p className="text-[#0D1B2A] font-semibold">Track Campaign Contributions</p>
      </div>
    </div>
  </div>
);
  ...
  <div className="bg-white rounded-lg shadow p-8">
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg">
        ...
        <p className="text-[#0D1B2A] font-semibold">Employee Engagement Analytics</p>
      </div>
    </div>
  </div>
);

// This is a placeholder component for reporting content
  ...
  <div className="bg-white rounded-lg shadow p-8">
    ...
    <div className="space-y-4">
      <div className="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg">
        ...
        <p className="text-[#0D1B2A] font-semibold">Impact Reports</p>
      </div>
      <div className="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg">
        <Download size={24} className="text-[#0D1B2A]" />
        <p className="text-[#0D1B2A] font-semibold">Download CSV Data</p>
      </div>
    </div>
  </div>
);
...
const CorporateDashboard = () => {
  ...
  const handleSignOut = () => {
    console.log("Signing out corporate user...");
    navigate("/");
  };
