...
import {
    Download, Home, LogOut, Users, DollarSign, Calendar, PlusCircle, BarChart2, Info, User
} from "lucide-react";
...
const EventsContent = ({ navigate }) => {
    const handleAddClick = () => {
        navigate('/dashboard/ngo/events/add');
    };
    const handleViewAllClick = () => {
        navigate('/dashboard/ngo/events/list');
    };
    return (
...
const NGODashboard = () => {
    ...
    const renderTabContent = () => {
        switch (activeTab) {
            case "events":
                return <EventsContent navigate={navigate} />;
            case "volunteers":
